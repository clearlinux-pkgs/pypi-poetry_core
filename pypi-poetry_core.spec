...
Source0  : https://files.pythonhosted.org/packages/44/ca/c2d21635a4525d427ae969d4cde155fb055c3b5d0bc4199b6de35bb6a826/poetry_core-2.1.3.tar.gz
...
%prep
%setup -q -n poetry_core-2.1.3
cd %{_builddir}/poetry_core-2.1.3
pushd ..
cp -a poetry_core-2.1.3 buildavx2
popd
pushd ..
cp -a poetry_core-2.1.3 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746458661
