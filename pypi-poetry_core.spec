...
Source0  : https://files.pythonhosted.org/packages/36/66/6af2891495d12020419c8447d0b29c1e96f3be16631faaed6bda5b886d5d/poetry_core-1.8.1.tar.gz
...
%prep
%setup -q -n poetry_core-1.8.1
cd %{_builddir}/poetry_core-1.8.1
pushd ..
cp -a poetry_core-1.8.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698852566
