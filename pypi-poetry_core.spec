...
Source0  : https://files.pythonhosted.org/packages/69/52/b73aade26e2487159ad2c1b5fd7cd2b76532e146dd36f99b4be4f741b13b/poetry_core-1.5.1.tar.gz
...
%prep
%setup -q -n poetry_core-1.5.1
cd %{_builddir}/poetry_core-1.5.1
pushd ..
cp -a poetry_core-1.5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676920968
