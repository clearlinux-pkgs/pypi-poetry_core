...
Source0  : https://files.pythonhosted.org/packages/c7/5c/3609519b7d890ced542fe327ea26a7c8ea55ef298c323c46cca2a011c1cb/poetry_core-1.9.1.tar.gz
...
%prep
%setup -q -n poetry_core-1.9.1
cd %{_builddir}/poetry_core-1.9.1
pushd ..
cp -a poetry_core-1.9.1 buildavx2
popd
pushd ..
cp -a poetry_core-1.9.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728917180
