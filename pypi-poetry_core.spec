...
Source0  : https://files.pythonhosted.org/packages/f2/db/20a9f9cae3f3c213a8c406deb4395698459fd96962cea8f2ccb230b1943c/poetry_core-1.9.0.tar.gz
...
%prep
%setup -q -n poetry_core-1.9.0
cd %{_builddir}/poetry_core-1.9.0
pushd ..
cp -a poetry_core-1.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706892929
