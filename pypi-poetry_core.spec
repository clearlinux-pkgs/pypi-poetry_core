...
Source0  : https://files.pythonhosted.org/packages/57/bb/2435fef60bb01f6c0891d9482c7053b50e90639f0f74d7658e99bdd4da69/poetry_core-1.5.0.tar.gz
...
%prep
%setup -q -n poetry_core-1.5.0
cd %{_builddir}/poetry_core-1.5.0
pushd ..
cp -a poetry_core-1.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674943255
