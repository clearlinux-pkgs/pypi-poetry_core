...
Source0  : https://files.pythonhosted.org/packages/8e/70/83d629533a57950f38f5bda64cea57c7c566cb6ad01e4c5380a13a2ac138/poetry_core-2.1.1.tar.gz
...
%prep
%setup -q -n poetry_core-2.1.1
cd %{_builddir}/poetry_core-2.1.1
pushd ..
cp -a poetry_core-2.1.1 buildavx2
popd
pushd ..
cp -a poetry_core-2.1.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740084533
